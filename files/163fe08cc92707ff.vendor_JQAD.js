...
(self.webpackChunk_canva_web=self.webpackChunk_canva_web||[]).push([[25436], {
    435135:(t,e)=> {
        "use strict";
        ...
        function d(t) {
            switch(t) {
                case"i8":return 5120;
                case"u8":return 5121;
                case"i16":return 5122;
                case"u16":return 5123;
                case"i32":return 5124;
                case"u32":return 5125;
                case"f32":return 5126;
                default:throw new c(t)
            }
        }
        const y= {
            FLOAT: {
                type:"float",name:"float",length:1
            }
            ,VEC2: {
                type:"float",name:"vec2",length:2
            }
            ,VEC3: {
                type:"float",name:"vec3",length:3
            }
            ,VEC4: {
                type:"float",name:"vec4",length:4
            }
        }
        ,v= {
            MAT2: {
                type:"matrix",name:"mat2",length:4
            }
            ,MAT3: {
                type:"matrix",name:"mat3",length:9
            }
            ,MAT4: {
                type:"matrix",name:"mat4",length:16
            }
        }
        ,m= {
            INT: {
                type:"int",name:"int",length:1
            }
            ,IVEC2: {
                type:"int",name:"ivec2",length:2
            }
            ,IVEC3: {
                type:"int",name:"ivec3",length:3
            }
            ,IVEC4: {
                type:"int",name:"ivec4",length:4
            }
            ,SAMPLER2D: {
                type:"int",name:"sampler2D",length:1
            }
        }
        ,b=new Map([[5126,y.FLOAT],[35664,y.VEC2],[35665,y.VEC3],[35666,y.VEC4],[35674,v.MAT2],[35675,v.MAT3],[35676,v.MAT4],[5124,m.INT],[35667,m.IVEC2],[35668,m.IVEC3],[35669,m.IVEC4],[35678,m.SAMPLER2D]]);
        class g {
            constructor(t) {
                var e;
        ...
        const _= {
            points:0,lines:1,"line loop":2,"line strip":3,triangles:4,"triangle strip":5,"triangle fan":6
        }
        ,T= {
            zero:0,one:1,"src color":768,"one minus src color":769,"dst color":774,"one minus dst color":775,"src alpha":770,"one minus src alpha":771,"dst alpha":772,"one minus dst alpha":773,"constant color":32769,"one minus constant color":32770,"constant alpha":32771,"one minus constant alpha":32772,"src alpha saturate":776
        }
        ,A= {
            front:1028,back:1029,"front and back":1032
        }
        ,O= {
            cw:2304,ccw:2305
        }
        ...
        ,R= {
            source:"one",destination:"zero",equation:"add"
        }
        ;
        const N= {
            never:512,less:513,equal:514,lequal:515,greater:516,notequal:517,gequal:518,always:519
        }
        ;
        class S {
            constructor( {
                primitive:t="triangles",shader:e,attributes:n,indices:r,count:i=0,instances:o,uniforms:s= {
                }
                ,textures:a= {
                }
                ,blend:u,depthTest:c,cullFace:l,frontFace:f,renderTarget:h
            }
            ) {
                var d;
                ...
                (n),this.indices=r?(d=r,Array.isArray(d)&&(d=new Uint16Array(d)),p(d)&&(d=new w(d)),d):void 0,this.count=i,this.instances=o,this.uniforms=s,this.textures=a,this._cullFace=l?A[l]:void 0,this._frontFace=f?O[f]:2305,this.blend=u?function(t) {
                    ...
                    ,i= {
                        ...R,...null!=(n=t.alpha)?n:t
                    }
                    ;
                    return {
                        rgb: {
                            source:T[r.source],destination:T[r.destination],equation:x[r.equation]
                        }
                        ,alpha: {
                            source:T[i.source],destination:T[i.destination],equation:x[i.equation]
                        }
                    }
                }
                (u):void 0,this.depthTest=c?function(t) {
                    var e,n;
                    return {
                        mask:null==(e=t.mask)||e,func:N[null!=(n=t.func)?n:"less"],range: {
                            near:0,far:1,...t.range
                        }
                    }
                }
        ...
        function M(t,e) {
            return {
                width:"fixed"===t.size?t.width||e.width:(t.width||1)*e.width,height:"fixed"===t.size?t.height||e.height:(t.height||1)*e.height
            }
        }
        function D(t,e) {
            ...
            const n=t.createBuffer(),r="buffer"===e.resourceType?t.ARRAY_BUFFER:t.ELEMENT_ARRAY_BUFFER;
        ...
        function U(t,e) {
            const {
                meta:n,name:r,location:i,data:o
            }
            =e,s=o.flat();
            if("int"===n.type)switch(n.length) {
                case 1:t.uniform1iv(i,s);
                break;
                case 2:t.uniform2iv(i,s);
                break;
                case 3:t.uniform3iv(i,s);
                break;
                case 4:t.uniform4iv(i,s);
                break;
                default:throw new a(`Could not set the value for uniform '${r}'. Make sure its length is between 1 and 4 (inclusive).`)
            } else if("float"===n.type)switch(n.length) {
                case 1:t.uniform1fv(i,s);
                break;
                case 2:t.uniform2fv(i,s);
                break;
                case 3:t.uniform3fv(i,s);
                break;
                case 4:t.uniform4fv(i,s);
                break;
                default:throw new a(`Could not set the value for uniform '${r}'. Make sure its length is between 1 and 4 (inclusive).`)
            } else switch(n.length) {
                case 4:t.uniformMatrix2fv(i,!1,s);
                break;
                case 9:t.uniformMatrix3fv(i,!1,s);
                break;
                case 16:t.uniformMatrix4fv(i,!1,s);
                break;
                default:throw new a(`Could not set the value for uniform '${r}'. Make sure its length is between 2 and 4 (inclusive).`)
            }
        }
        function H(t,e,n) {
            (function(t) {
        ...
        function G(t,e) {
            const n=function(t,e,n) {
                ...
                const s=H(t,t.VERTEX_SHADER,e),a=H(t,t.FRAGMENT_SHADER,n);
            ...
            t.useProgram(n);
            const o=t.getProgramParameter(n,t.ACTIVE_ATTRIBUTES),s=new Map;
            for(let r=0;
            r<o;
            r++) {
                const e=t.getActiveAttrib(n,r),i=e?t.getAttribLocation(n,e.name):-1;
            ...
            const c=t.getProgramParameter(n,t.ACTIVE_UNIFORMS),l=new Map,f=new Map;
            let h=0;
            for(let r=0;
            r<c;
            r++) {
                const e=t.getActiveUniform(n,r),i=e?t.getUniformLocation(n,e.name):null;
            ...
            return t.useProgram(null), {
                program:n,attributes:s,textures:l,uniforms:f
            }
        }
        function V(t,e) {
            return M(e, {
                width:t.drawingBufferWidth,height:t.drawingBufferHeight
            }
            )
        }
        function q(t,e,n) {
            ...
            const o=t.TEXTURE_2D,a=null!=(r=null==n?void 0:n.texture)?r:t.createTexture();
            ...
            const u="rgb"===e.colorFormat?t.RGB:t.RGBA,c="f32"===e.numberFormat?t.FLOAT:t.UNSIGNED_BYTE,l=function(t,e) {
            ...
            (t,e),f=z(e),h=!n||!l||l!==n.hash;
            if(f&&h)if("image"!==e.textureType) {
                const n=e.source,r=function(t,e,n) {
        ...
        class W {
            ...
            update() {
                for(let t=0;
                t<this.maxAttribs;
                t++)this.shouldEnable[t]!==this.hasEnabled[t]&&(this.hasEnabled[t]=this.shouldEnable[t],this.shouldEnable[t]?this.gl.enableVertexAttribArray(t):this.gl.disableVertexAttribArray(t))
            }
            reset() {
                for(let t=0;
                t<this.maxAttribs;
                t++)this.shouldEnable[t]=!1
            }
        }
        class X {
            constructor(t,e) {
            ...
            load(t) {
                const e=this.gl,n=Array.isArray(t)?t:t.resources;
                for(const r of n)switch(r.resourceType) {
                    case"buffer":case"elements":this.bufferCache.has(r.id)||this.bufferCache.set(r.id,D(e,r));
                    break;
                    case"shader":this.shaderCache.has(r.id)||this.shaderCache.set(r.id,G(e,r));
                    break;
                    case"texture":this.textureCache.has(r.id)||this.textureCache.set(r.id,q(e,r));
                    break;
                    default:throw new c(r)
                }
            }
            update(t) {
                const e=this.gl,n=Array.isArray(t)?t:t.resources;
                for(const r of n)if("texture"===r.resourceType) {
            ...
            clear(t,e) {
                ...
                const i=Array.isArray(t),s=i?t:t.color,a=i?1:t.depth,u=i?255:t.stencil,c=void 0!==s,l=void 0!==a,f=void 0!==u;
            ...
            render(t) {
                var e,n,r,i,u,c,l;
                const f=this.gl,h=Array.isArray(t)?t:t.renderables;
                for(const p of h) {
                    ...
                    for(const[s, {
                        ...
                        const c=d(null!=(e=t.type)?e:t.buffer.dataType),l=this.getBuffer(t.buffer);
                    ...
                    const y= {
                        ...p.uniforms,...this.commonUniforms
                    }
                    ;
            ...
            readPixels(t) {
                ...
                if(t) {
                    ...
                    width:n.drawingBufferWidth,height:n.drawingBufferHeight
                }
                ;
            ...
            dispose() {
                ...
                for(let r=0;
                r<n;
                r++)e.activeTexture(e.TEXTURE0+r),e.bindTexture(e.TEXTURE_2D,null),e.bindTexture(e.TEXTURE_CUBE_MAP,null);
            ...
            deleteResource(t,e) {
                ...
                const r=this.gl;
                switch(e) {
                    case"buffer":case"elements":const i=this.bufferCache.get(t)||null;
                    r.deleteBuffer(i),this.bufferCache.delete(t);
                    break;
                    case"shader":const o=this.shaderCache.get(t);
                    r.deleteProgram((null==o?void 0:o.program)||null),this.shaderCache.delete(t);
                    break;
                    case"texture":const s=null==(n=this.textureCache.get(t))?void 0:n.texture;
            ...
            get commonUniforms() {
                return {
                    uResolution:[this.gl.drawingBufferWidth,this.gl.drawingBufferHeight],uViewSize:this.canvasSize,uDevicePixelRatio:[this.env.devicePixelRatio]
                }
            }
            get canvasSize() {
        ...
        ;
        function $(t) {
            return t.replace(/void\s+main\(\s*\)\s* {
                ([\s\S]*?)
            }
            \s*$/,((t,e)=>`void main() {${e}gl_FragColor.rgb *= gl_FragColor.a;\n}`))
        }
        function J(t) {
            return function(t) {
        ...
        function et(t,e,n,r,i=Q) {
            ...
            const a=function(t,e,n,r) {
                return new B( {
                    name:t,width:e,height:n,size:r||"relative",colorFormat:"rgba",numberFormat:"u8"
                }
                )
            }
            (`pooled-render-texture-${o.length.toString()}`,e,n,r);
            return o.push( {
                texture:a,width:e,height:n,size:r
            }
            ),a
        }
        class nt {
            constructor(t) {
                this.index=0,this._textures=null!=t?t:[new B( {
                    colorFormat:"rgba",numberFormat:"u8"
                }
                ),new B( {
                    colorFormat:"rgba",numberFormat:"u8"
                }
        ...
        const rt=class t {
            static createPingpongBuffers( {
                width:t,height:e,size:n
            }
            = {
            }
            ) {
                const r=et([],t,e,n),i=et([r],t,e,n);
                return new nt([r,i])
            }
            constructor( {
                passes:e,uniforms:n,textures:r,options: {
                    buffers:i,renderTarget:o,enableOneTriangleOptimisation:s
                }
                = {
                }
            }
            ...
            convertShorthands(t,e) {
                return {
                    ...
                    :t)),uniforms:Object.fromEntries(Object.entries(null!=e?e: {
                    }
                    ).map((([t,e])=>[t,J(e)])))
                }
            }
            ...
            getRenderables(t,e,n,r,i) {
                const o=t.slice(0,-1).map((t=> {
                    const i=this.getShader(t,!1),o=n.currentBuffer(),s=t.output?this.getRenderTexture(t.output,e):n.nextBuffer();
            ...
            getRenderable(t,e,n,r,i,o) {
                const s=this.uniforms,a=this.getTextures(t, {
                    ...o,[K]:n
                }
                ,i),u=this.enableOneTriangleOptimisation?Z:Y;
                return new S( {
                    ...u,shader:e,uniforms:s,textures:a,renderTarget:r
                }
                )
            }
            getShader(t,e) {
                ...
                return new C( {
                    vertexSource:n,fragmentSource:r
                }
                )
            }
            ...
            getTextures(t,e,n) {
                if(t.inputs)for(const r of t.inputs)e[r]=this.getRenderTexture(r,n);
                return e
            }
            update( {
                textures:t,uniforms:e,renderTarget:n
            }
            ) {
                if(t)for(const[r,i]of Object.entries(t))if(i)for(const t of this.renderables)t.textures[r]=i;
                if(e)for(const[r,i]of Object.entries(e))this.uniforms[r]&&(this.uniforms[r]=J(i));
                if(void 0!==n) {
                    const t=this.renderables[this.renderables.length-1],e=null===n?this.finalPassShaderForCanvas:this.finalPassShaderForRenderTexture;
        ...
        function lt(t) {
            const {
                source:e,colorFormat:n,width:r,height:i
            }
            =t, {
                canvas:o,context:s
            }
            ...
            for(let l=0,f=0;
            l<e.length;
            l+=a?4:3,f+=4)c[f]=e[l],c[f+1]=e[l+1],c[f+2]=e[l+2],c[f+3]=a?e[l+3]:255;
        ...
        const ht="LkEaxkGQc",pt="mXA59BV4k",dt="ihJIFSpvi",yt="mjiW1vcGg",vt="T1GP6ZTnQ",mt="x8cqPYjGq",bt="zAvK5sktl",gt="j5BD_wqsh",Et="Flt8u8M0x",wt="zztE2SnZx",_t="LPlLw5zPI",Tt="MLGoNA0wv",At="m5a6RRSnk",Ot="MpMrqOkTf";
        var xt=1e-6,Rt="undefined"!=typeof Float32Array?Float32Array:Array;
        function Nt() {
            var t=new Rt(9);
        ...
        function Pt(t,e,n) {
            var r=e[0],i=e[1],o=e[2],s=e[3],a=e[4],u=e[5],c=e[6],l=e[7],f=e[8],h=e[9],p=e[10],d=e[11],y=e[12],v=e[13],m=e[14],b=e[15],g=n[0],E=n[1],w=n[2],_=n[3];
        ...
        function Lt(t,e) {
            var n=e[0],r=e[1],i=e[2],o=e[3],s=n+n,a=r+r,u=i+i,c=n*s,l=r*s,f=r*a,h=i*s,p=i*a,d=i*u,y=o*s,v=o*a,m=o*u;
        ...
        ;
        !function() {
            var t=It(),e=jt(1,0,0),n=jt(0,1,0)
        }
        (),function() {
            var t=Bt(),e=Bt()
        }
        ...
        ();
        const Dt=new j( {
            width:1,height:1,source:new Uint8Array([0,0,0,0])
        }
        );
        const Ft=t=> {
            if(void 0===t.camera)return {
                cameraKind:"perspective",perspective: {
                    aspectRatio:1.7777777,yfov:.39959652046304894,znear:.10000000149011612,zfar:1e3
                }
                ,id:-1,name:"default camera",rotation:[0,0,0,0],scale:[1,1,1],translation:[0,0,.3499999940395355]
            }
            ;
            const e=void 0!==t.camera.perspective?"perspective":"orthographic";
            return"perspective"===e? {
                name:t.name,id:t.id,translation:t.translation,rotation:t.rotation,scale:t.scale,cameraKind:e,perspective:t.camera.perspective
            }
            : {
                name:t.name,id:t.id,translation:t.translation,rotation:t.rotation,scale:t.scale,cameraKind:e,orthographic:t.camera.orthographic
            }
        }
        ,Ut=1313821514,Ht=5130562;
        ...
        ,zt=async t=>(await fetch(t)).arrayBuffer(),Wt=t=>(new TextDecoder).decode(t);
        class Xt {
            constructor(t,e,n) {
            ...
            async accessorData(t) {
                ...
                const e=this.gltf.accessors[t],n=qt[e.type];
                return {
                    buffer:await this.getBufferViewFromAccessor(e),elementsPerType:n
                }
            }
            async getBufferViewFromAccessor(t) {
                ...
                const e=qt[t.type],n=Vt[t.componentType].BYTES_PER_ELEMENT*e*t.count;
                return new Uint8Array(n)
            }
            async bufferViewData(t,e) {
                if(!this.gltf.bufferViews)throw new Error("No buffer views found.");
                const n=this.gltf.bufferViews[t],r=await this.getBufferData(n.buffer),i=n.byteLength||0,o=n.byteOffset||0,s=r.buffer,a=r.byteOffset;
                switch(e) {
                    case Gt.GLTF_BUFFER_TYPE_BYTE:return new Int8Array(s,a+o,i);
                    case Gt.GLTF_BUFFER_TYPE_UNSIGNED_BYTE:return new Uint8Array(s,a+o,i);
                    case Gt.GLTF_BUFFER_TYPE_SHORT:return new Int16Array(s,a+o,i/2);
                    case Gt.GLTF_BUFFER_TYPE_UNSIGNED_SHORT:return new Uint16Array(s,a+o,i/2);
                    case Gt.GLTF_BUFFER_TYPE_UNSIGNED_INT:return new Uint32Array(s,a+o,i/4);
                    case Gt.GLTF_BUFFER_TYPE_FLOAT:return new Float32Array(s,a+o,i/4)
                }
            ...
            async getImageData(t) {
                ...
                if(void 0!==e.bufferView) {
                    const t=await this.bufferViewData(e.bufferView,Gt.GLTF_BUFFER_TYPE_BYTE),r=new Blob([t], {
                        type:e.mimeType
                    }
                    );
        ...
        const Kt=async t=> {
            ...
            e=t.startsWith("http")||t.startsWith("blob")?t:(t=> {
                try {
                    ...
                    for(let r=0,i=t.length;
                    r<i;
                    r++)n[r]=t.charCodeAt(r);
                    return e
                }
                return t
            }
            )(t);
            const n=Zt(e),r=await Yt(e);
            return new Xt(n,r.json,r.chunks)
        }
        ,Zt=t=> {
            let e="";
            try {
                const n=new URL(t),r=n.href.split("/");
        ...
        ,Yt=async t=> {
            ...
            try {
                e=JSON.parse(t),r= {
                    magic:"glTF",version:parseFloat(e.asset.version),length:0
                }
                ,n=new ArrayBuffer(0)
            } catch {
                ...
                r= {
                    magic:Wt(new Uint8Array(n,0,4)),version:e.getUint32(4,!0),length:e.getUint32(8,!0)
                }
            }
        ...
        ,Jt="placeholder",Qt=t=>t instanceof Uint16Array?5123:t instanceof Uint32Array?5125:5121,te=t=> {
            const e=[];
            return t.forEach(((t,n)=> {
                var r,i;
                t.name.toLowerCase().includes(Jt)?e.push( {
                    meshIndex:n,name:t.name
                }
                ):null!=(r=t.material)&&r.name.toLowerCase().includes(Jt)&&e.push( {
                    meshIndex:n,name:null==(i=t.material)?void 0:i.name
                }
                )
            }
            )),e
        ...
        ,ne=(t,e)=> {
            const n=(t=> {
                ...
                return t.mesh.forEach(((n,r)=> {
                    ...
                    e.push( {
                        name:t.name+"_"+(r+1).toString(),vertices:n.positions,normals:n.normals,uvs:i,tangent:n.tangent,indices:n.indices,material:n.material,id:r,renderingContextBase:Qt(n.indices)
                    }
                    )
                }
                )),e
            ...
            return {
                mesh:n,placeholder:te(n),targets:ee(t.mesh),transform:t.translation.length>0?Ct(St(),jt(t.translation[0],t.translation[1],t.translation[2])):St(),rotation:t.rotation.length>0?Lt(St(),Mt(t.rotation[0],t.rotation[1],t.rotation[2],t.rotation[3])):St(),scale:t.scale.length>0?jt(t.scale[0],t.scale[1],t.scale[2]):jt(1,1,1),name:t.name,parrent:e,positionPrevious:new Float32Array(r),positionNext:new Float32Array(r),animation: {
                    rotation: {
                        times:new Uint8Array,values:[],interpolation:""
                    }
                    ,transform: {
                        times:new Uint8Array,values:[],interpolation:""
                    }
                    ...
                    ,weights: {
                        times:new Uint8Array,values:new Float32Array,targets:[],interpolation:"",positions:[]
                    }
                }
                ,progression:0,extras:t.extras
            }
        }
        ,re=(t=-1,e="",n=[])=>( {
            id:t,name:e,children:n,mesh:[],scale:[],rotation:[],translation:[],camera:void 0,extras: {
                highlightCorrection:1,shadowCorrection:1
            }
        }
        );
        e.AdditiveBlending= {
            source:"src alpha",destination:"one",equation:"add"
        }
        ,e.BinaryTexture=j,e.Buffer=E,e.Effect=st,e.ElementsBuffer=w,e.FraglAllocationError=i,e.FraglCompilationError=r,e.FraglError=n,e.FraglInternalError=u,e.FraglPlatformError=s,e.FraglRuntimeError=o,e.FraglValidationError=a,e.GltfParser=class {
            ...
            async parse(t= {
                ...
                return this.model=[],this.asset=await Kt(this.src),this.images=await this.getTextureImages(t.imageFilesToReplace),this.updateTexturesData(),this.camera=re(),this.nodes=await this.getSubNodes(),this.cameraModel=this.getCameraModel(),this.clips=await this.getClips(),this.model=await this.getModel(),this.updateAnimation(), {
                    camera:this.cameraModel,model:this.model,images:this.images,textures:this.textures,samplers:this.samplers
                }
            }
                    ...
                    t.tracks.forEach((t=> {
                        ...
                        if(e>-1) {
                            ...
                            switch(t.targetProperty.toLocaleLowerCase()) {
                                case"translation":n.animation.transform.values=this.decodeVector3Animation(t.values,t.valuesElements),n.animation.transform.times=t.times,n.animation.transform.interpolation=t.interpolation;
                                break;
                                case"rotation":n.animation.rotation.values=this.decodeQuaternionAnimation(t.values,t.valuesElements),n.animation.rotation.times=t.times,n.animation.rotation.interpolation=t.interpolation;
                                break;
                                case"scale":n.animation.scale.values=this.decodeVector3Animation(t.values,t.valuesElements),n.animation.scale.times=t.times,n.animation.scale.interpolation=t.interpolation;
                                break;
                                case"weights":n.targets.length>0&&(n.animation.weights.targets=this.model[e].targets,n.animation.weights.times=t.times,n.animation.weights.values=t.values,n.animation.weights.interpolation=t.interpolation,((t,e)=> {
                                    const n=t.values.length/t.targets.length;
                                    for(let r=0;
                                    r<n;
                                    r++) {
                                        const n=r*t.targets.length,i=[];
                                        for(let r=0;
                                        r<e;
                                        r+=3) {
            ...
            getTracks(t) {
                ...
                return Promise.all(t.channels.map((async n=> {
                    var r;
                    const i=t.samplers[n.sampler],o=await e.accessorData(i.input),s=await e.accessorData(i.output);
                    return {
                        targetIndex:n.target.node,targetObject:e.gltf.nodes[n.target.node].name,targetProperty:n.target.path,interpolation:null!=(r=i.interpolation)?r:"LINEAR",times:o.buffer,timesElements:o.elementsPerType,values:s.buffer,valuesElements:s.elementsPerType
                    }
                }
                )))
            }
            ...
            updateTexturesData() {
                ...
                this.samplers=null!=(t=e.samplers)?t:[],void 0!==e.textures&&e.textures.forEach(((t,e)=> {
                    t&&(this.textures[e]= {
                        sampler:t.sampler,source:t.source
                    }
                    )
                }
                ))
            ...
            async getTextureImages(t) {
                ...
                const e=this.asset.gltf.images.map((async(e,n)=> {
                    ...
                    return t?this.replaceImages(e,t): {
                        mimeType:e.mimeType,name:e.name,img:await(null==(r=this.asset)?void 0:r.getImageData(n))
                    }
                }
                ));
            ...
            async getSubNodes(t,e) {
                const n=this.getGltfFromAsset(),r=0|n.scene,i=n.scenes[r],o=(void 0===t?i.nodes:t).map((async t=> {
                    const r=n.nodes[t],i=re(t,r.name);
            ...
            async getTargets(t) {
                const e=this.getAsset(),n=t.targets.map((async t=> {
                    const n= {
                        normals:new Uint8Array(0),positions:new Uint8Array(0),tangent:new Uint8Array(0)
                    }
                    ;
            ...
            async getSubMesh(t) {
                const e=this.getAsset(),n=t.primitives.map((async t=> {
                    const n= {
                        positions:new Uint8Array(0),normals:new Uint8Array(0),uvs:new Uint8Array(0),tangent:new Uint8Array(0),indices:new Uint8Array(0),targets:[],material:void 0
                    }
                    ;
        ...
        ,e.ImageTexture=I,e.MockWebGLRenderingContext=class {
            ...
            getShaderPrecisionFormat() {
                return {
                    rangeMin:127,rangeMax:127,precision:127
                }
            }
            getShaderSource() {
                return""
        ...
        ,e.ModelViewer=class {
            constructor(t) {
                ...
                ,this.projectionMatrix=St(),this.viewMatrix=St(),this.modelMatrix=St(),this.modelViewProjectionMatrix=St(),this._renderables=t
            }
            get renderables() {
            ...
            updateAll( {
                ...
                if(t)for(const e of this.renderables)t.uCameraPosition&&(e.uniforms[Tt]=t.uCameraPosition),t.uMVPMatrix&&(e.uniforms[vt]=t.uMVPMatrix),t.uNormalMatrix&&(e.uniforms[_t]=t.uNormalMatrix)
            }
            updateOne( {
                id:t,textures:e
            }
            ...
            getUniformsToUpdateView(t,e) {
                return {
                    uniforms: {
                        uCameraPosition:[...t],uMVPMatrix:this.createMVPMatrix(e,t),uNormalMatrix:this.createNormalMatrix()
                    }
                }
            }
            createMVPMatrix(t,e) {
                kt(this.projectionMatrix,.4,t,.01,1e3);
                const n=jt(0,0,0),r=jt(0,1,0);
                return function(t,e,n,r) {
                    var i,o,s,a,u,c,l,f,h,p,d=e[0],y=e[1],v=e[2],m=r[0],b=r[1],g=r[2],E=n[0],w=n[1],_=n[2];
            ...
            createNormalMatrix() {
                const t=Nt();
                return function(t,e) {
                    var n=e[0],r=e[1],i=e[2],o=e[3],s=e[4],a=e[5],u=e[6],c=e[7],l=e[8],f=e[9],h=e[10],p=e[11],d=e[12],y=e[13],v=e[14],m=e[15],b=n*a-r*s,g=n*u-i*s,E=n*c-o*s,w=r*u-i*a,_=r*c-o*a,T=i*c-o*u,A=l*y-f*d,O=l*v-h*d,x=l*m-p*d,R=f*v-h*y,N=f*m-p*y,S=h*m-p*v,P=b*S-g*N+E*R+w*x-_*O+T*A;
        ...
        ,e.ModelViewerGltfData=class {
            ...
            gltfMeshToRenderable(t) {
                ...
                const {
                    baseColorFactor:e,baseColorTexture:n,isBaseColorTexture:r,metallicFactor:i,roughnessFactor:o,roughnessTexture:a,isRoughnessTexture:u,normalTexture:c,isNormalTexture:l,placeholder:f,isPlaceholderTexture:h,isDoubleSided:p
                }
                =this.gltfMaterialToTextures(t.material,this.gltf.images,this.gltf.textures),d=r?1:0,y=l?1:0,v=h?1:0,m=u?1:0;
                return new S( {
                    attributes: {
                        [dt]:new E(t.vertices),[yt]:new E(t.normals),[wt]:new E(t.uvs)
                    }
                    ,textures: {
                        [gt]:n,[Et]:f,[At]:c,[Ot]:a
                    }
                    ,uniforms: {
                        [Tt]:[0,0,0],[ht]:[e[0],e[1],e[2],e[3]],[bt]:[i],[mt]:[o],[pt]:[d,y,v,m],[vt]:Array.from(St()),[_t]:Array.from(Nt())
                    }
                    ,shader:this.shader,indices:new w(t.indices),depthTest: {
                        mask:!0,func:"less",range: {
                            near:0,far:1
                        }
                    }
                    ,...!p&& {
            ...
            gltfMaterialToTextures(t,e,n) {
                const r=t.pbrMetallicRoughness.baseColorFactor,i=t.pbrMetallicRoughness.metallicFactor,o=t.pbrMetallicRoughness.roughnessFactor,s=void 0!==t.pbrMetallicRoughness.baseColorTexture,a=t.pbrMetallicRoughness.baseColorTexture?new I( {
                    source:e[n[t.pbrMetallicRoughness.baseColorTexture.index].source].img
                }
                ):Dt,u=t.normalTexture?new I( {
                    source:e[n[t.normalTexture.index].source].img
                }
                ):Dt,c=void 0!==t.normalTexture,l=t.pbrMetallicRoughness.metallicRoughnessTexture?new I( {
                    source:e[n[t.pbrMetallicRoughness.metallicRoughnessTexture.index].source].img
                }
                ):Dt,f=void 0!==t.pbrMetallicRoughness.metallicRoughnessTexture,h=t.name.includes("placeholder");
                return {
                    baseColorFactor:r,baseColorTexture:a,metallicFactor:i,roughnessFactor:o,roughnessTexture:l,isRoughnessTexture:f,isBaseColorTexture:s,normalTexture:u,isNormalTexture:c,placeholder:Dt,isPlaceholderTexture:h,isDoubleSided:t.doubleSided
                }
            }
        ...
        ,e.OrbitControls=class {
            constructor(t, {
                initialDistance:e,minDistance:n,maxDistance:r,initialRotation:i
            }
            ) {
                ...
                ,this.tick=()=> {
                    ...
                    const t=this.velocity[0]*this.velocity[0],e=this.velocity[1]*this.velocity[1];
            ...
            updatePosition() {
                const t=this.rotation[0],e=this.rotation[1],n=Math.cos(t)*Math.sin(e),r=Math.cos(e),i=Math.sin(t)*Math.sin(e);
        ...
        ,e.PingpongBuffers=nt,e.PremultipliedNormalBlending= {
            source:"one",destination:"one minus src alpha",equation:"add"
        }
        ...
        ,e.Shader=C,e.WebGlRenderer=X,e._renderTexturePool=tt,e.createWebGlRenderer=function(t,e) {
            ...
            const c= {
                alpha:null==(n=null==e?void 0:e.alpha)||n,antialias:null==(r=null==e?void 0:e.antialias)||r,depth:null!=(o=null==e?void 0:e.depth)&&o,stencil:!1,preserveDrawingBuffer:!(null==e||!e.preserveDrawingBuffer),powerPreference:"high-performance",failIfMajorPerformanceCaveat:!(null==e||!e.failIfMajorPerformanceCaveat)
            }
    ...
    ,968:t=> {
        ...
        window,e=function() {
            ...
            ([function(t,e,n) {
                ...
                var r=n(1),i=n.n(r),o=n(10),s=n.n(o),a=n(17),u=n.n(a),c=n(2),l=n(5),f=n(3),h=n(9),p=n(6),d=n(25),y=n(11),v=n(20);
                function m(t) {
                ...
                var _=Object(y.a)("quill"),T=new c.Registry;
                ...
                var A=function() {
                    function t(e) {
                        ...
                        this.scroll=new o(this.options.registry,this.root, {
                            ...
                            var i=n.selection.lastRange,o=g(n.selection.getRange(),1)[0],s=i&&o? {
                                oldRange:i,newRange:o
                            }
                            :void 0;
                            x.call(n,(function() {
                    ...
                    , {
                        key:"editReadOnly",value:function(t) {
                    ...
                    , {
                        key:"format",value:function(t,e) {
                            var n=this,r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:f.a.sources.API;
                            return x.call(this,(function() {
                                var r=n.getSelection(!0),o=new i.a;
                                if(null==r)return o;
                                if(n.scroll.query(t,c.Scope.BLOCK))o=n.editor.formatLine(r.index,r.length,b( {
                                }
                                ,t,e));
                                else {
                                    if(0===r.length)return n.selection.format(t,e),o;
                                    o=n.editor.formatText(r.index,r.length,b( {
                                    }
                                    ,t,e))
                                }
                    ...
                    , {
                        key:"formatLine",value:function(t,e,n,r,i) {
                            var o,s=this,a=g(R(t,e,n,r,i),4);
                    ...
                    , {
                        key:"getBounds",value:function(t) {
                            ...
                            return {
                                bottom:e.bottom-r.top,height:e.height,left:e.left-r.left,right:e.right-r.left,top:e.top-r.top,width:e.width
                            }
                        }
                    }
                    , {
                        key:"getContents",value:function() {
                            var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:0,e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:this.getLength()-t,n=g(R(t,e),2);
                    ...
                    , {
                        key:"getSemanticHTML",value:function() {
                            var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:0,e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:this.getLength()-t,n=g(R(t,e),2);
                    ...
                    , {
                        key:"insertEmbed",value:function(e,n,r) {
                            var i=this,o=arguments.length>3&&void 0!==arguments[3]?arguments[3]:t.sources.API;
                            return x.call(this,(function() {
                    ...
                    , {
                        key:"insertText",value:function(t,e,n,r,i) {
                            var o,s=this,a=g(R(t,0,n,r,i),4);
                    ...
                    , {
                        key:"setContents",value:function(t) {
                            var e=this,n=arguments.length>1&&void 0!==arguments[1]?arguments[1]:f.a.sources.API;
                            return x.call(this,(function() {
                                t=new i.a(t);
                                var n=e.getLength(),r=e.editor.deleteText(0,n),o=e.editor.applyDelta(t),s=e.editor.deleteText(e.getLength()-1,1);
                    ...
                    , {
                        key:"setText",value:function(t) {
                            var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:f.a.sources.API,n=(new i.a).insert(t);
                            return this.setContents(n,e)
                        }
                    }
                    , {
                        key:"update",value:function() {
                            var t=arguments.length>0&&void 0!==arguments[0]?arguments[0]:f.a.sources.USER,e=this.scroll.update(t);
                ...
                function O(t,e) {
                    if((e=u()( {
                        container:t,modules: {
                            clipboard:!0,keyboard:!0,history:!0,uploader:!0
                        }
                    }
                    ...
                    var r=Object.keys(n.modules).concat(Object.keys(e.modules)).reduce((function(t,e) {
                        ...
                        return null==n?_.error("Cannot load ".concat(e," module. Are you sure you registered it?")):t[e]=n.DEFAULTS|| {
                        }
                        ,t
                    }
                    ), {
                ...
                function x(t,e,n,r) {
                    ...
                    var o=null==n?null:this.getSelection(),s=this.editor.delta,a=t();
                ...
                A.DEFAULTS= {
                    ...
                    ,placeholder:"",readOnly:!1,registry:T,scrollingContainer:null,theme:"default"
                }
                ,A.events=f.a.events,A.sources=f.a.sources,A.version="2.0.0-dev.46",A.imports= {
                    delta:i.a,parchment:c,"core/module":h.a,"core/theme":v.a
                }
            }
            ,function(t,e,n) {
                "use strict";
                ...
                ,i=r(n(50)),o=r(n(10)),s=r(n(18)),a=r(n(51)),u=r(n(42)),c=String.fromCharCode(0),l=function() {
                    function t(t) {
                    ...
                    ,t.prototype.slice=function(e,n) {
                        ...
                        for(var r=[],i=u.default.iterator(this.ops),o=0;
                        o<n&&i.hasNext();
                        ) {
                            var s=void 0;
                    ...
                    ,t.prototype.compose=function(e) {
                        var n=u.default.iterator(this.ops),r=u.default.iterator(e.ops),i=[],o=r.peek();
                        if(null!=o&&"number"==typeof o.retain&&null==o.attributes) {
                            for(var c=o.retain;
                            "insert"===n.peekType()&&n.peekLength()<=c;
                            )c-=n.peekLength(),i.push(n.next());
                        ...
                        n.hasNext()||r.hasNext();
                            ...
                            var f=Math.min(n.peekLength(),r.peekLength()),h=n.next(f),p=r.next(f);
                    ...
                    ,t.prototype.diff=function(e,n) {
                        ...
                        )),o=new t,l=i.default(r[0],r[1],n),f=u.default.iterator(this.ops),h=u.default.iterator(e.ops);
                        return l.forEach((function(t) {
                            for(var e=t[1].length;
                            e>0;
                            ) {
                                var n=0;
                                switch(t[0]) {
                                    case i.default.INSERT:n=Math.min(h.peekLength(),e),o.push(h.next(n));
                                    break;
                                    case i.default.DELETE:n=Math.min(e,f.peekLength()),f.next(n),o.delete(n);
                                    break;
                                    case i.default.EQUAL:n=Math.min(f.peekLength(),h.peekLength(),e);
                                    var r=f.next(n),u=h.next(n);
                    ...
                    ,t.prototype.eachLine=function(e,n) {
                        void 0===n&&(n="\n");
                        for(var r=u.default.iterator(this.ops),i=new t,o=0;
                        r.hasNext();
                        ) {
                            if("insert"!==r.peekType())return;
                            var s=r.peek(),a=u.default.length(s)-r.peekLength(),c="string"==typeof s.insert?s.insert.indexOf(n,a)-a:-1;
                            if(c<0)i.push(r.next());
                            else if(c>0)i.push(r.next(c));
                            else {
                                if(!1===e(i,r.next(1).attributes|| {
                                }
                                ,o))return;
                                o+=1,i=new t
                            }
                    ...
                    ,t.prototype.transform=function(e,n) {
                        ...
                        for(var r=e,i=u.default.iterator(this.ops),o=u.default.iterator(r.ops),s=new t;
                        i.hasNext()||o.hasNext();
                        )if("insert"!==i.peekType()||!n&&"insert"===o.peekType())if("insert"===o.peekType())s.push(o.next());
                        else {
                            var c=Math.min(i.peekLength(),o.peekLength()),l=i.next(c),f=o.next(c);
                    ...
                    ,t.prototype.transformPosition=function(t,e) {
                        void 0===e&&(e=!1),e=!!e;
                        for(var n=u.default.iterator(this.ops),r=0;
                        n.hasNext()&&r<=t;
                        ) {
                            var i=n.peekLength(),o=n.peekType();
            ...
            ,function(t,e,n) {
                ...
                var o,s=r,a=function() {
                    ...
                    ,t.prototype.indexOf=function(t) {
                        for(var e=this.iterator(),n=e(),r=0;
                        n;
                        ) {
                            if(n===t)return r;
                            r+=1,n=e()
                    ...
                    ,t.prototype.forEachAt=function(t,e,n) {
                        if(!(e<=0))for(var r=this.find(t),i=r[0],o=t-r[1],s=this.iterator(i),a=s();
                        a&&o<t+e;
                        ) {
                            var u=a.length();
                ...
                (Error),f=function() {
                    ...
                    ,t.prototype.create=function(e,n,r) {
                        ...
                        var o=i,s=n instanceof Node||n.nodeType===Node.TEXT_NODE?n:o.create(r),a=new o(e,s,r);
                ...
                (),h=f,p=function() {
                    ...
                    ,t.prototype.insertAt=function(t,e,n) {
                        var r=null==n?this.scroll.create("text",e):this.scroll.create(e,n),i=this.split(t);
                ...
                var v=function(t) {
                    ...
                    ,e.prototype.descendant=function(t,n) {
                        void 0===n&&(n=0);
                        var r=this.children.find(n),i=r[0],o=r[1];
                    ...
                    ,e.prototype.insertAt=function(t,e,n) {
                        var r=this.children.find(t),i=r[0],o=r[1];
                    ...
                    ,e.prototype.optimize=function(e) {
                        if(t.prototype.optimize.call(this,e),this.enforceAllowedChildren(),null!=this.uiNode&&this.uiNode!==this.domNode.firstChild&&this.domNode.insertBefore(this.uiNode,this.domNode.firstChild),0===this.children.length)if(null!=this.statics.defaultChild) {
                    ...
                    ,e.prototype.path=function(t,n) {
                        void 0===n&&(n=!1);
                        var r=this.children.find(t,n),i=r[0],o=r[1],s=[[this,t]];
                ...
                (),w=function(t) {
                    ...
                    ,e.prototype.value=function() {
                        ...
                        )[this.statics.blotName]=this.statics.value(this.domNode)||!0,t
                    }
            ...
            (r.StyleAttributor),p=new h("font","font-family",l)
        }
        ,function(t,e,n) {
            "use strict";
            n.d(e,"a",(function() {
            ...
            var r=n(2),i=new r.ClassAttributor("size","ql-size", {
                scope:r.Scope.INLINE,whitelist:["small","large","huge"]
            }
            ),o=new r.StyleAttributor("size","font-size", {
                scope:r.Scope.INLINE,whitelist:["10px","18px","32px"]
            }
            )
        }
        ,,function(t,e,n) {
            ...
            var v=function(t) {
                ...
                function n(t,r) {
                    ...
                    var o=r.ownerDocument.createElement("span"),s=function(e) {
                        if(t.isEnabled()) {
        ...
        ,function(t,e,n) {
                ...
                return e=l,(n=[ {
                    key:"change",value:function(t,e) {
                        if(0!==this.stack[t].length) {
                            var n=this.stack[t].pop(),r=this.quill.getContents(),o=n.invert(r);
            ...
            f.DEFAULTS= {
                delay:1e3,maxStack:100,userOnly:!1
            }
        }
        ,,,function(t,e,n) {
            "use strict";
            n.r(e);
            var r=n(0),i=n(4),o=n(8),s=n(15),a=n(16),u=n(37),c=n(12),l=n(14),f=n(7),h=n(38),p=n(33),d=n(19),y=n(1),v=n.n(y),m=n(3);
            function b(t) {
            ...
            var T=function(t) {
                ...
                function o(t,e) {
                    ...
                    (this,o),n=i.call(this,t,e),t.root.addEventListener("drop",(function(e) {
                        ...
                        var o=t.selection.normalizeNative(r),s=t.selection.normalizedToRange(o);
                        n.upload(s,e.dataTransfer.files)
                    }
                    )),n
                }
                return e=o,(n=[ {
                    key:"upload",value:function(t,e) {
                        var n=this,r=[];
            ...
            (n(9).a);
            T.DEFAULTS= {
                mimetypes:["image/png","image/jpeg"],handler:function(t,e) {
            ...
            var A=T;
            r.a.register( {
                "blots/block":i.d,"blots/block/embed":i.a,"blots/break":o.a,"blots/container":s.a,"blots/cursor":a.a,"blots/embed":u.a,"blots/inline":c.a,"blots/scroll":l.a,"blots/text":f.a,"modules/clipboard":h.a,"modules/history":p.a,"modules/keyboard":d.b,"modules/uploader":A
            }
            ),e.default= {
                Quill:r.a
            }
        ...
        ,function(t,e,n) {
            ...
            var r=n(1),i=n.n(r),o=n(2),s=n(4),a=n(0),u=n(11),c=n(9),l=n(24),f=n(28),h=n(13),p=n(21),d=n(22),y=n(29),v=n(30),m=n(19);
            function b(t,e) {
                var n=Object.keys(t);
            ...
            var S=Object(u.a)("quill:clipboard"),P=[[Node.TEXT_NODE,function(t,e) {
                var n=t.data;
            ...
            ],[Node.TEXT_NODE,H],["br",function(t,e) {
                return j(e,"\n")||e.insert("\n"),e
            }
            ],[Node.ELEMENT_NODE,H],[Node.ELEMENT_NODE,function(t,e,n) {
                var r=n.query(t);
                if(null==r)return e;
                ...
                var r=o.Attributor.keys(t),i=o.ClassAttributor.keys(t),s=o.StyleAttributor.keys(t),a= {
                }
                ;
                ...
                for(var o=-1,s=t.parentNode;
                null!=s;
                )["OL","UL"].includes(s.tagName)&&(o+=1),s=s.parentNode;
                ...
                var r=n.query("code-block"),i=!r||r.formats(t,n);
                return I(e,"code-block",i)
            }
            ],["tr",function(t,e) {
                var n="TABLE"===t.parentNode.tagName?t.parentNode:t.parentNode.parentNode,r=Array.from(n.querySelectorAll("tr")).indexOf(t)+1;
                return I(e,"table",r)
            }
            ],["b",U.bind(U,"bold")],["i",U.bind(U,"italic")],["strike",U.bind(U,"strike")],["style",function() {
                return new i.a
            }
                ...
                , {
                    key:"convert",value:function(t) {
                        var e=t.html,n=t.text,r=arguments.length>1&&void 0!==arguments[1]?arguments[1]: {
                        }
                        ;
                        if(r[h.c.blotName])return(new i.a).insert(n,w( {
                        }
                        ,h.c.blotName,r[h.c.blotName]));
                ...
                , {
                    key:"convertHTML",value:function(t) {
                        var e=(new DOMParser).parseFromString(t,"text/html").body,n=new WeakMap,r=_(this.prepareMatching(e,n),2),i=r[0],o=r[1];
                ...
                , {
                    key:"onCapturePaste",value:function(t) {
                        if(!t.defaultPrevented&&this.quill.isEnabled()) {
                            t.preventDefault();
                            var e=this.quill.getSelection(!0);
                            if(null!=e) {
                                var n=t.clipboardData.getData("text/html"),r=t.clipboardData.getData("text/plain"),i=Array.from(t.clipboardData.files||[]);
                ...
                , {
                    key:"onCopy",value:function(t) {
                        var e=this.quill.getText(t);
                        return {
                            html:this.quill.getSemanticHTML(t),text:e
                        }
                    }
                }
                , {
                    key:"onPaste",value:function(t,e) {
                        var n=e.text,r=e.html,o=this.quill.getFormat(t.index),s=this.convert( {
                            text:n,html:r
                        }
                        ,o);
                        S.log("onPaste",s, {
                ...
                , {
                    key:"prepareMatching",value:function(t,e) {
                        var n=[],r=[];
                        return this.matchers.forEach((function(i) {
                            var o=_(i,2),s=o[0],a=o[1];
                            switch(s) {
                                case Node.TEXT_NODE:r.push(a);
                                break;
                                case Node.ELEMENT_NODE:n.push(a);
                                break;
                                default:Array.from(t.querySelectorAll(s)).forEach((function(t) {
            ...
            function H(t,e,n) {
                if(!j(e,"\n")) {
                    ...
                    if(e.length()>0&&t.nextSibling)for(var r=t.nextSibling;
                    null!=r;
                    ) {
        ...
        ,function(t,e) {
            ...
            ,u.prototype.listeners=function(t) {
                ...
                if(!n)return[];
                if(n.fn)return[n.fn];
                for(var i=0,o=n.length,s=new Array(o);
                i<o;
                i++)s[i]=n[i].fn;
                return s
            }
            ...
            ,u.prototype.emit=function(t,e,n,i,o,s) {
                ...
                if(l.fn) {
                    switch(l.once&&this.removeListener(t,l.fn,void 0,!0),f) {
                        ...
                        case 6:return l.fn.call(l.context,e,n,i,o,s),!0
                    }
            ...
            ,u.prototype.removeListener=function(t,e,n,i) {
                ...
                if(s.fn)s.fn!==e||i&&!s.once||n&&s.context!==n||a(this,o);
                    ...
                    for(var u=0,c=[],l=s.length;
                    u<l;
                    u++)(s[u].fn!==e||i&&!s[u].once||n&&s[u].context!==n)&&c.push(s[u]);
        ...
        ,,,,,,,function(t,e) {
            ...
            function o(t,e,l,f) {
                ...
                if(null!=l) {
                    var h=function(t,e,n) {
                        ...
                        :n.oldRange,i="number"==typeof n?null:n.newRange,o=t.length,s=e.length;
                        if(0===r.length&&(null===i||0===i.length)) {
                            var a=r.index,u=t.slice(0,a),c=t.slice(a),l=i?i.index:null,f=a+s-o;
                            ...
                            if(null===l||l===a) {
                                var y=a,v=(h=e.slice(0,y),e.slice(y));
                                if(h===u) {
                        ...
                        if(r.length>0&&i&&0===i.length) {
                            ...
                            if(!(s<(p=b.length)+(m=g.length))) {
                                var E=e.slice(0,p),w=e.slice(s-m);
                ...
                var p=a(t,e),y=t.substring(0,p);
                p=u(t=t.substring(p),e=e.substring(p));
                var v=t.substring(t.length-p),m=function(t,e) {
                    var c;
                    if(!t)return[[r,e]];
                    if(!e)return[[n,t]];
                    var l=t.length>e.length?t:e,f=t.length>e.length?e:t,h=l.indexOf(f);
                    if(-1!==h)return c=[[r,l.substring(0,h)],[i,f],[r,l.substring(h+f.length)]],t.length>e.length&&(c[0][0]=c[2][0]=n),c;
                    if(1===f.length)return[[n,t],[r,e]];
                    var p=function(t,e) {
                        var n=t.length>e.length?t:e,r=t.length>e.length?e:t;
                        if(n.length<4||2*r.length<n.length)return null;
                        function i(t,e,n) {
                            for(var r,i,o,s,c=t.substring(n,n+Math.floor(t.length/4)),l=-1,f="";
                            -1!==(l=e.indexOf(c,l+1));
                            ) {
                                var h=a(t.substring(n),e.substring(l)),p=u(t.substring(0,n),e.substring(0,l));
                        ...
                        var o,s,c,l,f,h=i(n,r,Math.ceil(n.length/4)),p=i(n,r,Math.ceil(n.length/2));
                        if(!h&&!p)return null;
                    ...
                    (t,e);
                    if(p) {
                        var d=p[0],y=p[1],v=p[2],m=p[3],b=p[4],g=o(d,v),E=o(y,m);
                        return g.concat([[i,b]],E)
                    }
                    return function(t,e) {
                        for(var i=t.length,o=e.length,a=Math.ceil((i+o)/2),u=a,c=2*a,l=new Array(c),f=new Array(c),h=0;
                        h<c;
                        h++)l[h]=-1,f[h]=-1;
                        l[u+1]=0,f[u+1]=0;
                        for(var p=i-o,d=p%2!=0,y=0,v=0,m=0,b=0,g=0;
                        g<a;
                        g++) {
                            for(var E=-g+y;
                            E<=g-v;
                            E+=2) {
                                for(var w=u+E,_=(R=E===-g||E!==g&&l[w-1]<l[w+1]?l[w+1]:l[w-1]+1)-E;
                                R<i&&_<o&&t.charAt(R)===e.charAt(_);
                                )R++,_++;
                                if(l[w]=R,R>i)v+=2;
                                else if(_>o)y+=2;
                            ...
                            T<=g-b;
                            T+=2) {
                                for(var A,O=u+T,x=(A=T===-g||T!==g&&f[O-1]<f[O+1]?f[O+1]:f[O-1]+1)-T;
                                A<i&&x<o&&t.charAt(i-A-1)===e.charAt(o-x-1);
                                )A++,x++;
                                if(f[O]=A,A>i)b+=2;
                                else if(x>o)m+=2;
                                else if(!d) {
                                    var R;
                                    if((w=u+p-T)>=0&&w<c&&-1!==l[w])if(_=u+(R=l[w])-w,R>=(A=i-A))return s(t,e,R,_)
                                }
                            }
                        }
                        return[[n,t],[r,e]]
            ...
            function s(t,e,n,r) {
                var i=t.substring(0,n),s=e.substring(0,r),a=t.substring(n),u=e.substring(r),c=o(i,s),l=o(a,u);
                return c.concat(l)
            }
            function a(t,e) {
                if(!t||!e||t.charAt(0)!==e.charAt(0))return 0;
                for(var n=0,r=Math.min(t.length,e.length),i=r,o=0;
                n<i;
                )t.substring(o,i)==e.substring(o,i)?o=n=i:r=i,i=Math.floor((r-n)/2+n);
            ...
            function u(t,e) {
                ...
                for(var n=0,r=Math.min(t.length,e.length),i=r,o=0;
                n<i;
                )t.substring(t.length-i,t.length-o)==e.substring(e.length-i,e.length-o)?o=n=i:r=i,i=Math.floor((r-n)/2+n);
                return f(t.charCodeAt(t.length-i))&&i--,i
            }
            function c(t,e) {
                t.push([i,""]);
                for(var o,s=0,l=0,f=0,d="",y="";
                s<t.length;
                ...
                for(s=1;
                s<t.length-1;
                )t[s-1][0]===i&&t[s+1][0]===i&&(t[s][1].substring(t[s][1].length-t[s-1][1].length)===t[s-1][1]?(t[s][1]=t[s-1][1]+t[s][1].substring(0,t[s][1].length-t[s-1][1].length),t[s+1][1]=t[s-1][1]+t[s+1][1],t.splice(s-1,1),E=!0):t[s][1].substring(0,t[s+1][1].length)==t[s+1][1]&&(t[s-1][1]+=t[s+1][1],t[s][1]=t[s][1].substring(t[s+1][1].length)+t[s+1][1],t.splice(s+1,1),E=!0)),s++;
                E&&c(t,e)
            }
            function l(t) {
        ...
        ,function(t,e,n) {
            ...
            var i=r(n(42)),o=function() {
                ...
                ,t.prototype.next=function(t) {
                    ...
                    if(e) {
                        var n=this.offset,r=i.default.length(e);
...
,23278:(t,e,n)=> {
    "use strict";
    function r(t,e) {
        var n=e&&e.cache?e.cache:l,r=e&&e.serializer?e.serializer:u;
        return(e&&e.strategy?e.strategy:a)(t, {
            cache:n,serializer:r
        }
        )
    }
    function i(t,e,n,r) {
...
,264100:(t,e,n)=> {
    ...
    function i(t,e) {
        ...
        r++) {
            ...
            if("j"===i) {
                for(var s=0;
                r+1<t.length&&t.charAt(r+1)===i;
                )s++,r++;
                var a=1+(1&s),u=s<2?1:3+(s>>1),c=o(e);
                for("H"!=c&&"k"!=c||(u=0);
                u-- >0;
                )n+="a";
                for(;
...
,363014:(t,e,n)=> {
    "use strict";
    n.d(e, {
        HI:()=>s.HI,Ii:()=>s.Ii,Jo:()=>s.Jo,O4:()=>s.O4,Qc:()=>u,VG:()=>s.VG,Wh:()=>s.Wh,Wi:()=>s.Wi,pe:()=>s.pe,rp:()=>s.rp,uf:()=>s.uf,yx:()=>s.yx
    }
    );
    var r=n(46239),i=n(853219),o=n(655697),s=n(823511);
    function a(t) {
        t.forEach((function(t) {
            if(delete t.location,(0,s.Wi)(t)||(0,s.Jo)(t))for(var e in t.options)delete t.options[e].location,a(t.options[e].value);
...
,655697:(t,e,n)=> {
    ...
    var r,i=n(46239),o=n(853219),s=n(823511),a=n(846500),u=n(473767),c=n(989558),l=n(264100),f=new RegExp("^".concat(a.p.source,"*")),h=new RegExp("".concat(a.p.source,"*$"));
    function p(t,e) {
        return {
            start:t,end:e
        }
    }
    var d=!!String.prototype.startsWith&&"_a".startsWith("a",1),y=!!String.fromCodePoint,v=!!Object.fromEntries,m=!!String.prototype.codePointAt,b=!!String.prototype.trimStart,g=!!String.prototype.trimEnd,E=!!Number.isSafeInteger?Number.isSafeInteger:function(t) {
    ...
    var C=function() {
            ...
            !this.isEOF();
                ...
                if(123===i) {
                    ...
                    if(35!==i||"plural"!==e&&"selectordinal"!==e) {
                        ...
                        this.bump(),r.push( {
                            type:s.wD.pound,location:p(u,this.clonePosition())
                        }
                        )
                    }
                }
        ...
        ,t.prototype.parseTag=function(t,e) {
            ...
            if(this.bumpSpace(),this.bumpIf("/>"))return {
                val: {
                    type:s.wD.literal,value:"<".concat(r,"/>"),location:p(n,this.clonePosition())
                }
                ,err:null
            }
            ;
            if(this.bumpIf(">")) {
                ...
                if(i.err)return i;
                var a=i.val,u=this.clonePosition();
                if(this.bumpIf("</")) {
                    ...
                    return r!==this.parseTagName()?this.error(o.o.UNMATCHED_CLOSING_TAG,p(c,this.clonePosition())):(this.bumpSpace(),this.bumpIf(">")? {
                        val: {
                            type:s.wD.tag,value:r,children:a,location:p(n,this.clonePosition())
                        }
                        ,err:null
                    }
        ...
        ,t.prototype.parseTagName=function() {
            var t,e=this.offset();
            for(this.bump();
            !this.isEOF()&&(45===(t=this.char())||46===t||t>=48&&t<=57||95===t||t>=97&&t<=122||t>=65&&t<=90||183==t||t>=192&&t<=214||t>=216&&t<=246||t>=248&&t<=893||t>=895&&t<=8191||t>=8204&&t<=8205||t>=8255&&t<=8256||t>=8304&&t<=8591||t>=11264&&t<=12271||t>=12289&&t<=55295||t>=63744&&t<=64975||t>=65008&&t<=65533||t>=65536&&t<=983039);
            )this.bump();
        ...
        ,t.prototype.parseLiteral=function(t,e) {
            ...
            return {
                val: {
                    type:s.wD.literal,value:r,location:u
                }
                ,err:null
            }
        }
        ...
        ,t.prototype.parseArgument=function(t,e) {
            ...
            switch(this.char()) {
                case 125:return this.bump(), {
                    val: {
                        type:s.wD.argument,value:r,location:p(n,this.clonePosition())
                    }
                    ,err:null
                }
                ;
                case 44:return this.bump(),this.bumpSpace(),this.isEOF()?this.error(o.o.EXPECT_ARGUMENT_CLOSING_BRACE,p(n,this.clonePosition())):this.parseArgumentOptions(t,e,r,n);
                default:return this.error(o.o.MALFORMED_ARGUMENT,p(n,this.clonePosition()))
            }
        }
        ,t.prototype.parseIdentifierIfPossible=function() {
            var t=this.clonePosition(),e=this.offset(),n=_(this.message,e),r=e+n.length;
            return this.bumpTo(r), {
                value:n,location:p(t,this.clonePosition())
            }
        }
        ,t.prototype.parseArgumentOptions=function(t,e,n,r) {
            var a,c=this.clonePosition(),f=this.parseIdentifierIfPossible().value,h=this.clonePosition();
            switch(f) {
                case"":return this.error(o.o.EXPECT_ARGUMENT_TYPE,p(c,h));
                ...
                if(this.bumpIf(",")) {
                    ...
                    d= {
                        style:g,styleLocation:p(y,this.clonePosition())
                    }
                }
                ...
                if(d&&T(null==d?void 0:d.style,"::",0)) {
                    ...
                    if("number"===f)return(A=this.parseNumberSkeletonFromString(m,d.styleLocation)).err?A: {
                        val: {
                            type:s.wD.number,value:n,location:v,style:A.val
                        }
                        ,err:null
                    }
                    ;
                    ...
                    var g= {
                        type:s.aV.dateTime,pattern:b,location:d.styleLocation,parsedOptions:this.shouldParseSkeletons?(0,u.T)(b): {
                        }
                    }
                    ;
                    return {
                        val: {
                            type:"date"===f?s.wD.date:s.wD.time,value:n,location:v,style:g
                        }
                        ,err:null
                    }
                }
                return {
                    val: {
                        type:"number"===f?s.wD.number:"date"===f?s.wD.date:s.wD.time,value:n,location:v,style:null!==(a=null==d?void 0:d.style)&&void 0!==a?a:null
                    }
                    ,err:null
                }
                ;
                case"plural":case"selectordinal":case"select":var E=this.clonePosition();
                if(this.bumpSpace(),!this.bumpIf(","))return this.error(o.o.EXPECT_SELECT_ARGUMENT_OPTIONS,p(E,(0,i.pi)( {
                }
                ,E)));
                this.bumpSpace();
                ...
                return"select"===f? {
                    val: {
                        type:s.wD.select,value:n,options:O(S.val),location:P
                    }
                    ,err:null
                }
                : {
                    val: {
                        type:s.wD.plural,value:n,options:O(S.val),offset:_,pluralType:"plural"===f?"cardinal":"ordinal",location:P
                    }
                    ,err:null
                }
                ;
                default:return this.error(o.o.INVALID_ARGUMENT_TYPE,p(c,h))
            }
        }
        ...
        ,t.prototype.parseSimpleArgStyleIfPossible=function() {
            for(var t=0,e=this.clonePosition();
            !this.isEOF();
            ) {
                switch(this.char()) {
                    case 39:this.bump();
                    ...
                    break;
                    case 125:if(!(t>0))return {
                        val:this.message.slice(e.offset,this.offset()),err:null
                    }
                    ;
                    t-=1;
                    break;
        ...
        ,t.prototype.parseNumberSkeletonFromString=function(t,e) {
            ...
            return {
                val: {
                    type:s.aV.number,tokens:n,location:e,parsedOptions:this.shouldParseSkeletons?(0,c.I)(n): {
                    }
                }
                ,err:null
            }
        ...
        ,t.prototype.tryParsePluralOrSelectOptions=function(t,e,n,r) {
            ...
            ;
                ...
                if(v.err)return v;
                a.push([c, {
                    value:y.val,location:p(d,this.clonePosition())
                }
        ...
        ,t.prototype.clonePosition=function() {
            return {
                offset:this.position.offset,line:this.position.line,column:this.position.column
            }
        }
        ...
        ,t.prototype.error=function(t,e) {
            return {
                val:null,err: {
                    kind:t,message:this.message,location:e
                }
            }
        }
...
,823511:(t,e,n)=> {
    ...
    n.d(e, {
        HI:()=>p,Ii:()=>y,Jo:()=>f,O4:()=>o,VG:()=>s,Wh:()=>d,Wi:()=>l,aV:()=>i,pe:()=>c,rp:()=>u,uf:()=>a,wD:()=>r,yx:()=>h
    }
    ),function(t) {
